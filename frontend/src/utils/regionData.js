...
export const regionData = {
  ...
  '경기도': {
    ...
    districts: [
      ...
      '과천시', '구리시', '남양주시', '오산시', '시흥시', '군포시',
      '의왕시', '하남시', '용인시 처인구', '용인시 기흥구', '용인시 수지구',
      '파주시', '이천시', '안성시', '김포시', '화성시', '광주시',
      '여주시', '양평군', '고양군', '연천군', '포천시', '가평군'
    ]
  },
  '강원도': {
    name: '강원도',
...
export const getDistricts = (province) => {
  return regionData[province]?.districts || [];
};
...
export const getAllRegions = () => {
  ...
  provinces.forEach(province => {
    allRegions.push(province);
    const districts = getDistricts(province);
    districts.forEach(district => {
      allRegions.push(`${province} ${district}`);
    });
  });
  return allRegions;
};
...
export const searchRegions = (keyword) => {
  ...
  provinces.forEach(province => {
    ...
    const districts = getDistricts(province);
    districts.forEach(district => {
      if (district.includes(keyword) || province.includes(keyword)) {
