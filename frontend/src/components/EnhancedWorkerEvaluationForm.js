...
function EnhancedWorkerEvaluationForm({ workerId, workOrderId, sellerId, onSuccess, onCancel }) {
            ...
            {loading ? (
              <div className="flex items-center">
                <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" fill="none" viewBox="0 0 24 24">
                  ...
                  <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 8 5.373 8 12H4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                평가 중...
              </div>
            ) : (
...
export default EnhancedWorkerEvaluationForm; 